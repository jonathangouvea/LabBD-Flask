CREATE TABLE edital(
    ...
    reoferta INT(1,0) CHECK (reoferta=0 OR reoferta=1)-- utilizando como atributo booleano
);
...
(
    ...
    selecionado INT(1,0) CHECK (selecionado=0 OR selecionado=1),
...
CREATE TABLE Reuniao (
    id_reuniao               INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    documento_apresentacao    VARCHAR(4000),
...
CREATE TABLE ReuniaoParticipa (
    ...
    recurso_justificativa        VARCHAR(4000),
    aprovacao_justificativa     VARCHAR(4000),
...
CREATE TABLE AlteracaoVerba (
    ...
    Data                     DATE,
    Estado_da_aprovacao      VARCHAR(1000),
    Valor                    INT,
...
CREATE TABLE AlteracaoConteudo (
    ...
    Data                     DATE,
    Estado_da_aprovacao      VARCHAR(1000),
    Conteudo_substituido    VARCHAR(4000),
